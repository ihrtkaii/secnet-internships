...
4,479 employers tracked · data as of Sep 07, 2026 at 12:38 UTC
...
_Engine (last run): 4,320 of 4,727 registered boards returned successfully across 12 ATS platforms (93% of boards attempted, 91% of the full registry) · completed in 980.1s · 567 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
