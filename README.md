...
4,170 employers tracked · data as of Aug 14, 2026 at 21:52 UTC
...
_Engine (last run): 4,152 of 4,408 registered boards returned successfully across 12 ATS platforms (99% of boards attempted, 94% of the full registry) · completed in 952.0s · 586 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
