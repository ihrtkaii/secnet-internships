...
_Engine (last run): 4,295 of 4,661 registered boards returned successfully across 12 ATS platforms (93% of boards attempted, 92% of the full registry) · completed in 1059.4s · 578 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
