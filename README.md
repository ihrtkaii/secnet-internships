...
4,271 employers tracked · data as of Aug 22, 2026 at 13:13 UTC
...
_Engine (last run): 4,222 of 4,514 registered boards returned successfully across 12 ATS platforms (98% of boards attempted, 93% of the full registry) · completed in 970.6s · 573 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
