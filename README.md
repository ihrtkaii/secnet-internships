...
4,117 employers tracked · data as of Aug 12, 2026 at 08:03 UTC
...
_Engine (last run): 4,047 of 4,354 registered boards returned successfully across 12 ATS platforms (92% of boards attempted, 92% of the full registry) · completed in 971.5s · 564 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
