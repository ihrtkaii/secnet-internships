...
4,271 employers tracked · data as of Aug 24, 2026 at 04:17 UTC
...
_Engine (last run): 4,236 of 4,514 registered boards returned successfully across 12 ATS platforms (98% of boards attempted, 93% of the full registry) · completed in 926.9s · 585 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
