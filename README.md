...
4,271 employers tracked · data as of Aug 24, 2026 at 07:32 UTC
...
_Engine (last run): 4,174 of 4,514 registered boards returned successfully across 12 ATS platforms (97% of boards attempted, 92% of the full registry) · completed in 975.4s · 561 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
