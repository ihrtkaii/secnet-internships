...
4,249 employers tracked · data as of Aug 21, 2026 at 07:21 UTC
...
_Engine (last run): 4,169 of 4,492 registered boards returned successfully across 12 ATS platforms (98% of boards attempted, 92% of the full registry) · completed in 1028.1s · 560 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
