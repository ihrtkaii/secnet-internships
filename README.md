...
4,160 employers tracked · data as of Aug 14, 2026 at 05:12 UTC
...
_Engine (last run): 4,061 of 4,398 registered boards returned successfully across 12 ATS platforms (97% of boards attempted, 92% of the full registry) · completed in 842.6s · 538 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
