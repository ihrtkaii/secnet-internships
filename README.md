...
4,170 employers tracked · data as of Aug 14, 2026 at 13:53 UTC
...
_Engine (last run): 4,112 of 4,408 registered boards returned successfully across 12 ATS platforms (98% of boards attempted, 93% of the full registry) · completed in 1016.4s · 566 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
