...
4,259 employers tracked · data as of Aug 21, 2026 at 10:04 UTC
...
_Engine (last run): 4,189 of 4,502 registered boards returned successfully across 12 ATS platforms (98% of boards attempted, 93% of the full registry) · completed in 890.1s · 570 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
