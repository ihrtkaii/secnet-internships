...
4,327 employers tracked · data as of Aug 31, 2026 at 05:42 UTC
...
_Engine (last run): 4,174 of 4,572 registered boards returned successfully across 12 ATS platforms (96% of boards attempted, 91% of the full registry) · completed in 1005.4s · 547 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
