...
4,325 employers tracked · data as of Aug 29, 2026 at 18:41 UTC
...
_Engine (last run): 4,217 of 4,570 registered boards returned successfully across 12 ATS platforms (97% of boards attempted, 92% of the full registry) · completed in 1018.2s · 557 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
