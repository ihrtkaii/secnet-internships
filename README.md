...
4,117 employers tracked · data as of Aug 12, 2026 at 05:14 UTC
...
_Engine (last run): 4,060 of 4,354 registered boards returned successfully across 12 ATS platforms (93% of boards attempted, 93% of the full registry) · completed in 1014.8s · 558 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
