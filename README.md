...
4,139 employers tracked · data as of Aug 12, 2026 at 16:23 UTC
...
_Engine (last run): 4,074 of 4,376 registered boards returned successfully across 12 ATS platforms (94% of boards attempted, 93% of the full registry) · completed in 1012.3s · 572 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
