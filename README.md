...
4,160 employers tracked · data as of Aug 13, 2026 at 16:26 UTC
...
_Engine (last run): 4,130 of 4,398 registered boards returned successfully across 12 ATS platforms (98% of boards attempted, 93% of the full registry) · completed in 1151.1s · 588 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
