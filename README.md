...
4,271 employers tracked · data as of Aug 23, 2026 at 13:14 UTC
...
_Engine (last run): 4,130 of 4,514 registered boards returned successfully across 12 ATS platforms (96% of boards attempted, 91% of the full registry) · completed in 957.2s · 542 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
