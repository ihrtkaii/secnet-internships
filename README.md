...
4,183 employers tracked · data as of Aug 15, 2026 at 15:47 UTC
...
_Engine (last run): 4,050 of 4,422 registered boards returned successfully across 12 ATS platforms (96% of boards attempted, 91% of the full registry) · completed in 903.1s · 529 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
