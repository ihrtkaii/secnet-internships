...
4,183 employers tracked · data as of Aug 15, 2026 at 21:49 UTC
...
_Engine (last run): 4,116 of 4,422 registered boards returned successfully across 12 ATS platforms (98% of boards attempted, 93% of the full registry) · completed in 1017.4s · 559 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
